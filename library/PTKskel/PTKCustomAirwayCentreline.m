classdef PTKCustomAirwayCentreline < PTKPlugin
    ...
    methods (Static)
        function results = RunPlugin(dataset, reporting)
            ...
            reloadtemplate = dataset.GetResult('PTKOriginalImage');
            new_image = zeros(reloadtemplate.ImageSize, 'uint8');
            new_image(reloadtemplate.GlobalToLocalIndices(skeleton_results.CentrelinePoints)) = 1;
            new_image(reloadtemplate.GlobalToLocalIndices(skeleton_results.BifurcationPoints)) = 1;
            
            results = reloadtemplate.Copy;
