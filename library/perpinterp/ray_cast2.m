function [source_rays, seg_rays, coords] = ray_cast2(interp_source, interp_seg, center, num_rays, ray_interval)
                % Compute Rays in two directions.
                ...
                limit_row = abs(image_sz(1) - center(1))*2;
                limit_col = abs(image_sz(2) - center(2))*2;
                ray_length_limit = min(limit_row, limit_col);

                %Compute rays in polar coords
                ray_angle_interval = pi/num_rays;
                radial = [-ray_length_limit:ray_interval:0-ray_interval, 0:ray_interval:ray_length_limit];
                theata = 0:ray_angle_interval:pi;
